...
public class ApplicationDetailsPageTest {
    ...
    public void CreatPages() throws Exception{
        ApplicationDetailsPage = new BasePage("ApplicationDetailsPage", "ChineseTestOld/ApplicationDetailsPage.xml");
        //打开应用详情页面
        open("http://apptest.netease.im/application/info?appid=146289677");
        sleep(500);
    }
